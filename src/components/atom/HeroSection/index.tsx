...
const HeroSection:FC<IHeroSection> = (props: IHeroSection) => {
  ...
  return(
    <>
      <div className="hero-section-container relative mt-20 flex justify-center">
        <Image src={HeroImage} alt="hero-image" className="w-full contain-content"/>
        <div className="black-filter w-full h-full absolute bg-courtney-dark-blue opacity-60 top-0 rounded-bl-[15%]"></div>

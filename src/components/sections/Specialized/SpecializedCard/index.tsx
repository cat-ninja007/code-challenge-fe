  ...
  return (
    <>
      <div className="specialized-card-container w-[300px] flex mb-[27px]">
        <div className="yellow-badge w-[13px] h-[72px] bg-courtney-bright-yellow rounded-l-[12px] shadow-md"></div>
        <div className="card-content w-[90%] h-[72px] bg-white hover:bg-courtney-light-yellow rounded-r-[12px] shadow-md flex">
